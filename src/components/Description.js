...
function Description() {
  return (
    <div className=' w-screen flex flex-col items-center justify-center bg-cover h-500 xl:h-650 xl:w-1170 xl:bg-xl lg:bg-lg  md:bg-md  sm:bg-sm '>
      ...
      <p className='text-body text-center text-white w-380 sm:w-328 mt-21 whitespace-break-spaces whitespace-pre-wrap'>What defines a good front-end developer is one that has skilled knowledge of HTML, CSS, JS with a vast understanding of User design thinking as they'll be building web interfaces with accessibility in mind. They should also be excited to learn, as the world of Front-End Development keeps evolving. </p>
      <Button
        spacing='mt-8'
        type='button'
        variant='default'>
